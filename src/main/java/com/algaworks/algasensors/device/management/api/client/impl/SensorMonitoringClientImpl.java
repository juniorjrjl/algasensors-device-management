...
public class SensorMonitoringClientImpl implements SensorMonitoringClient {
    ...
    public SensorMonitoringClientImpl(final RestClientFactory factory){
    ...
    @Override
    public SensorMonitoringDetailResponse getDetail(final TSID sensorId) {
        return restClient.delete()
                .uri("/api/sensors/{sensorId}/monitoring", sensorId)
                .retrieve()
                .body(SensorMonitoringDetailResponse.class);
    }
